...
static const SeekeyThemePreset THEME_PRESETS[] = {
    ...
    {"nord", "#d8dee9", "alpha(#2e3440, 0.90)", "alpha(#88c0d0, 0.25)",
     "0 7px 22px alpha(#000000, 0.38)", "alpha(#d8dee9, 0.70)",
     "alpha(#2e3440, 0.58)", "alpha(#88c0d0, 0.16)"},
    {"dracula", "#f8f8f2", "alpha(#282a36, 0.90)", "alpha(#bd93f9, 0.24)",
     "0 7px 22px alpha(#000000, 0.38)", "alpha(#f8f8f2, 0.70)",
     "alpha(#282a36, 0.58)", "alpha(#bd93f9, 0.16)"},
    {"catppuccin", "#cdd6f4", "alpha(#1e1e2e, 0.90)", "alpha(#cba6f7, 0.22)",
     "0 7px 22px alpha(#000000, 0.38)", "alpha(#cdd6f4, 0.72)",
     "alpha(#1e1e2e, 0.58)", "alpha(#cba6f7, 0.14)"},
    {"monokai", "#f8f8f2", "alpha(#272822, 0.90)", "alpha(#a6e22e, 0.22)",
     "0 7px 22px alpha(#000000, 0.38)", "alpha(#f8f8f2, 0.72)",
     "alpha(#272822, 0.58)", "alpha(#a6e22e, 0.14)"},
};
